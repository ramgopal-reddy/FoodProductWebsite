...
export default function Spinner5() {
  return (
    <section className="bg-black position-center flex h-screen w-full items-center justify-center">
      <div className="bg-black container">
        <div className="flex bg-black flex-wrap items-center gap-4">
          <button className="inline-flex  h-12 items-center justify-center gap-2.5 rounded-lg border border-stroke bg-transparent px-6 py-3 text-base font-medium text-dark ">
            <span>
              <svg
              ...
              >
                <circle
                  ...
                  strokeWidth="2"
                />
                <mask id="path-2-inside-1_2527_20940" fill="black">
